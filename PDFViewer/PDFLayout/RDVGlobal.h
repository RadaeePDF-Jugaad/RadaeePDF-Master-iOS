...
@property (strong, nonatomic) NSString *g_annot_def_author;
...
@property (nonatomic) bool g_sel_rtol;
@property (nonatomic) bool g_screen_awake;
@property (nonatomic) bool g_auto_save_doc;
...
@property (nonatomic) bool g_exec_js;
