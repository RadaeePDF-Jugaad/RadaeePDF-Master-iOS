...
//UITextInputTraits
@class RDPDFCanvas;
@interface PDFLayoutView : UIScrollView <UIScrollViewDelegate, PDFOffScreenDelegate, RDVLayoutDelegate, PDFJSDelegate, UIKeyInput>
{
    RDPDFDoc *m_doc;
    RDVLayout *m_layout;
    NSTimer *m_timer;
    ...
    PDF_RECT m_edit_caret_rect;
    int m_edit_caret_sta;
    long long m_edit_pos0;
    long long m_edit_pos1;
    RDPDFEditNode *m_edit_node;
    NSTimer *m_edit_timer;
}
